...
class Pinger {
    ...
    boolean ping(int maxAttempts, int startTimeout) {
        ...
        while (attempts < maxAttempts) {
            try {
                ...
                Log.w("Error pinging server (attempt: " + attempts + ", timeout: " + timeout + "). ");
        ...
        Log.e(error, new ProxyCacheException(error));
        return false;
    }
    ...
    private boolean pingServer() throws ProxyCacheException {
        ...
        try {
            ...
            Log.i("Ping response: `" + new String(response) + "`, pinged? " + pingOk);
            return pingOk;
        } catch (ProxyCacheException e) {
            Log.e("Error reading ping response", e);
            return false;
        } finally {
            source.close();
        }
